...
import styles from "./AggregatedView.module.css";
...
export function AggregatedView({ activityTypes, refreshKey }: AggregatedViewProps) {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Failed to load aggregate");
      setData(null);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className={styles.root}>
      ...
      <p className={styles.hint}>
        ...
        <code>backend/app/rules/overlap.yaml</code> (e.g. read wins over sport).
      </p>
